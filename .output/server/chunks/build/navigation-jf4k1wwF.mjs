import { useSlots, computed, unref, mergeProps, withCtx, createBlock, createCommentVNode, createVNode, openBlock, renderSlot, createTextVNode, toDisplayString, Fragment, renderList, defineComponent, useSSRContext } from 'vue';
...
import { t as tv, d as _sfc_main$2 } from './Button-Cd0wPLJq.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "actions flex flex-row justify-between items-center w-full mb-10" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_UButton, {
        icon: "i-lucide-arrow-left",
        to: _ctx.$t(`${__props.page}.buttons.prev.to`),
        color: "neutral",
        variant: "outline"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t(`${__props.page}.buttons.prev.text`))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t(`${__props.page}.buttons.prev.text`)), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<p>${ssrInterpolate(_ctx.$t(`${__props.page}.title`))}</p>`);
      _push(ssrRenderComponent(_component_UButton, {
        "trailing-icon": "i-lucide-arrow-right",
        to: _ctx.$t(`${__props.page}.buttons.next.to`),
        color: "neutral",
        variant: "outline"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t(`${__props.page}.buttons.next.text`))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t(`${__props.page}.buttons.next.text`)), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/actions/navigation.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_7 = Object.assign(_sfc_main, { __name: "ActionsNavigation" });

export { _sfc_main$1 as _, __nuxt_component_7 as a };
//# sourceMappingURL=navigation-jf4k1wwF.mjs.map
