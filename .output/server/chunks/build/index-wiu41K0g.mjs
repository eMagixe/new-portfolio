...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-welcome border-b-2 border-default" }, _attrs))}><div class="flex flex-col justify-center items-center pt-10 photo">`);
...
const __nuxt_component_4_lazy_visible = createLazyVisibleComponent("components/section/projects.vue", () => import('./projects-EoCxz1yn.mjs').then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=index-wiu41K0g.mjs.map
