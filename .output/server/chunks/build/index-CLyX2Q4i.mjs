...
const __nuxt_component_4_lazy_visible = createLazyVisibleComponent("components/section/projects.vue", () => import('./projects-DeMjaNzq.mjs').then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=index-CLyX2Q4i.mjs.map
