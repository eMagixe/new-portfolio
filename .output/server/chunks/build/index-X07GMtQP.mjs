import { I as ImageComponent, _ as _sfc_main$4, a as _sfc_main$2$1, t as tv } from './Tooltip-Bjk-0mtq.mjs';
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, computed, renderSlot, defineAsyncComponent, h, resolveDynamicComponent, createCommentVNode, toDisplayString, useSSRContext, hydrateOnVisible } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrRenderVNode } from 'vue/server-renderer';
import { _ as __nuxt_component_1$1 } from './nuxt-link-BiOVwRpD.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(__nuxt_component_1$1)), mergeProps({
        to: __props.to,
        href: __props.href,
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-19608b61"]]), { __name: "AnimatedButton" });
const theme = {
  "slots": {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AnimatedButton = __nuxt_component_1;
      ...
      _push(`</div><div><div class="flex flex-col justify-center items-center text-center py-10 space-y-6"><h1 class="text-3xl font-bold text-primary!">${ssrInterpolate(_ctx.$t("index.name"))}</h1><p class="text-2xl w-1/2 m-5">${ssrInterpolate(_ctx.$t("index.description"))}</p><div class="flex flex-wrap gap-4 justify-center mt-5"><!--[-->`);
...
const __nuxt_component_1_lazy_visible = createLazyVisibleComponent("components/section/about.vue", () => import('./about-D1j8Kbx7.mjs').then((c) => c.default || c));
const __nuxt_component_2_lazy_visible = createLazyVisibleComponent("components/section/jobs.vue", () => import('./jobs-Da84iWuy.mjs').then((c) => c.default || c));
const __nuxt_component_3_lazy_visible = createLazyVisibleComponent("components/section/skills.vue", () => import('./skills-BTHS0J64.mjs').then((c) => c.default || c));
const __nuxt_component_4_lazy_visible = createLazyVisibleComponent("components/section/projects.vue", () => import('./projects-CpCmGDuP.mjs').then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=index-X07GMtQP.mjs.map
