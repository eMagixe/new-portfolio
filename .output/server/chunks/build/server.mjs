...
const _routes = [
  {
    name: "index___ru",
    path: "/",
    component: () => import('./index-X07GMtQP.mjs').then((n) => n.i)
  },
  {
    name: "index___en",
    path: "/en",
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/pDvabJxV"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/pDvabJxV"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CuFtYPih.mjs').then((m) => m.default || m))
};
