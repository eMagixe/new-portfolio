...
const _routes = [
  ...
  },
  {
    name: "projects___ru",
    path: "/projects",
    component: () => import('./projects-muoQU_8H.mjs')
  },
  {
    name: "projects___en",
    path: "/en/projects",
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/JIEpj5RF"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/JIEpj5RF"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DYgktyOQ.mjs').then((m) => m.default || m))
};
