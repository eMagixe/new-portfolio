...
const _routes = [
  {
    name: "jobs___ru",
    path: "/jobs",
    component: () => import('./jobs-CRQ6lsKT.mjs')
  },
  {
    name: "jobs___en",
    path: "/en/jobs",
  ...
  },
  {
    name: "about___ru",
    path: "/about",
    component: () => import('./about-DeEWKUqa.mjs')
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  },
  {
    ...
    component: () => import('./index-Dw4wXC6T.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "skills___ru",
    path: "/skills",
    component: () => import('./skills-CJZACD5w.mjs')
  },
  {
    name: "skills___en",
    path: "/en/skills",
  ...
  },
  {
    name: "projects___ru",
    path: "/projects",
    component: () => import('./projects-DtHj3K_Z.mjs')
  },
  {
    name: "projects___en",
    path: "/en/projects",
...
const LazyIcon = defineAsyncComponent(() => import('./index-u2G7qdl6.mjs').then((r) => r["default"] || r.default || r));
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/meiGqmIr"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/meiGqmIr"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BT3x93_e.mjs').then((m) => m.default || m)),
  home: defineAsyncComponent(() => import('./home-BePXAbMZ.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C3DYkXWZ.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useSeoMeta as b, __nuxt_component_5 as c, useRoute as d, entry_default as default, appConfig as e, useRouter as f, useNuxtApp as g, useRuntimeConfig as h, nuxtLinkDefaults as i, asyncDataDefaults as j, createError as k, navigateTo as n, resolveRouteObject as r, useHead as u };
