...
const _routes = [
  {
    name: "index___ru",
    path: "/",
    component: () => import('./index-C_48-1_Y.mjs').then((n) => n.i)
  },
  {
    name: "index___en",
    path: "/en",
...
const LazyIcon = defineAsyncComponent(() => import('./index-BDxtzh9K.mjs').then((r) => r["default"] || r.default || r));
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/VCtEN6D4"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/VCtEN6D4"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BoV68ANp.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BkepgnwE.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useI18n as b, useSeoMeta as c, useNuxtApp as d, entry_default as default, useRoute as e, appConfig$1 as f, useState as g, __nuxt_component_3 as h, useRuntimeConfig as i, useRequestEvent as j, appConfig as k, useRouter as l, encodeRoutePath as m, navigateTo as n, nuxtLinkDefaults as o, asyncDataDefaults as p, createError as q, resolveRouteObject as r, useHead as u };
