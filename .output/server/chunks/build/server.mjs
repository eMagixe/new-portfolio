...
import { hasInjectionContext, inject, toRef, isRef, defineComponent, ref, h, Suspense, computed, Fragment, getCurrentInstance as getCurrentInstance$1, shallowRef, provide, shallowReactive, defineAsyncComponent, createElementBlock, cloneVNode, unref, createApp, createVNode, Text, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'vue';
import { t as klona, v as defuFn, w as parseURL, x as encodePath, y as decodePath, z as hasProtocol, A as isScriptProtocol, r as joinURL, m as createError$1, B as withQuery, C as sanitizeStatusCode, D as getContext, $ as $fetch$1, E as baseURL, F as createHooks, G as defu, H as executeAsync, I as getRequestURL, J as getRequestHeader, K as getCookie, L as parse$1, o as destr, M as isEqual, N as createDefu, O as parsePath, P as parseQuery, Q as setCookie, R as deleteCookie, S as withoutTrailingSlash, T as isEqual$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "jobs___ru",
    path: "/jobs",
    component: () => import('./jobs-DItt0zD4.mjs')
  },
  {
    name: "jobs___en",
    path: "/en/jobs",
  ...
  },
  {
    name: "about___ru",
    path: "/about",
    component: () => import('./about-CZqdR9MO.mjs')
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  },
  {
    name: "index___ru",
    path: "/",
    component: () => import('./index-BVuvxQZl.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "skills___ru",
    path: "/skills",
    component: () => import('./skills-BaOWmjfd.mjs')
  },
  {
    name: "skills___en",
    path: "/en/skills",
  ...
  },
  {
    name: "projects___ru",
    path: "/projects",
    component: () => import('./projects-5F5LptC5.mjs')
  },
  {
    name: "projects___en",
    path: "/en/projects",
...
const LazyIcon = defineAsyncComponent(() => import('./index-BNNxeEIg.mjs').then((r) => r["default"] || r.default || r));
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/XKmHxO5X"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/XKmHxO5X"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-Cyvz6S6v.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bo49pslJ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CrN4BA-G.mjs'));
...
export { _export_sfc as _, useAppConfig as a, useI18n as b, useSeoMeta as c, useRoute as d, entry_default as default, appConfig$1 as e, useState as f, __nuxt_component_3 as g, appConfig as h, useNuxtApp as i, useRuntimeConfig as j, useRequestEvent as k, useRouter as l, encodeRoutePath as m, navigateTo as n, nuxtLinkDefaults as o, asyncDataDefaults as p, createError as q, resolveRouteObject as r, useHead as u };
