import { useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, watch, resolveDynamicComponent, toRef, toValue, provide, useModel, createTextVNode, mergeModels, isRef, useSSRContext } from 'vue';
import { X as serialize, G as defu, M as isEqual } from '../nitro/nitro.mjs';
...
import { t as tv, a as _sfc_main$2$1, I as ImageComponent } from './Tooltip-Bjk-0mtq.mjs';
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        __props.icon ? (openBlock(), createBlock(_sfc_main$2$1, {
                          key: 0,
                          name: __props.icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: props.ui?.icon })
...
export { _sfc_main as _, _sfc_main$1 as a, _sfc_main$3 as b, get as c, _sfc_main$2 as d, useFieldGroup as e, useComponentIcons as f, getSlotChildrenText as g, fieldGroupInjectionKey as h, isArrayOfArray as i, localeContextInjectionKey as l, omit as o, pickLinkProps as p, useLocale as u };
//# sourceMappingURL=Button-B-8L74Ra.mjs.map
