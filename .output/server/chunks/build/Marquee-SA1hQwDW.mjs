...
import { t as tv } from './Button-C5RHR-UA.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.marquee) || {} })({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.repeat, (i) => {
              var _a2;
              _push2(`<div data-slot="content" class="${ssrRenderClass(ui.value.content({ class: [(_a2 = props.ui) == null ? void 0 : _a2.content] }))}"${_scopeId}>`);
...
//# sourceMappingURL=Marquee-SA1hQwDW.mjs.map
