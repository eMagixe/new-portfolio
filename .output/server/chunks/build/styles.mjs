...
const styles = {
  ...
  "components/actions/up.vue": () => import('./up-styles.BBEBNnXj.mjs').then(interopDefault),
  "components/actions/up.vue?vue&type=style&index=0&lang.css": () => import('./up-styles.BBEBNnXj.mjs').then(interopDefault),
  "components/animated/button.vue": () => import('./button-styles.SMm7mrgH.mjs').then(interopDefault),
  "components/animated/button.vue?vue&type=style&index=0&scoped=19608b61&lang.css": () => import('./button-styles.SMm7mrgH.mjs').then(interopDefault)
};
