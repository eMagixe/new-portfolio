import { withCtx, createVNode, computed, unref, mergeProps, renderSlot, defineComponent, toRef, provide, useId, openBlock, createBlock, toDisplayString, useSlots, useModel, watch, createCommentVNode, createTextVNode, mergeModels, resolveDynamicComponent, withModifiers, Fragment, renderList, toHandlers, ref, inject, useTemplateRef, shallowReactive, reactive, markRaw, nextTick, useSSRContext } from 'vue';
...
import { Primitive, useForwardProps, ConfigProvider, TooltipProvider, useForwardPropsEmits, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, VisuallyHidden, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, DialogTitle, DialogDescription, DialogClose, ToastProvider, ToastPortal, ToastViewport, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ProgressRoot, ProgressIndicator } from 'reka-ui';
import { G as defu } from '../nitro/nitro.mjs';
import { reactivePick, createReusableTemplate, createSharedComposable } from '@vueuse/core';
import { l as localeContextInjectionKey, u as useLocale, g as getSlotChildrenText, _ as _sfc_main$m, a as _sfc_main$1$1, i as isArrayOfArray, b as _sfc_main$3$1, c as get, p as pickLinkProps, d as _sfc_main$2$1, e as useFieldGroup, f as useComponentIcons, o as omit, h as fieldGroupInjectionKey } from './Button-DDZVeAG-.mjs';
import { t as tv, p as portalTargetInjectionKey, _ as __nuxt_component_0$1, b as _sfc_main$3$2, a as _sfc_main$o, u as usePortal } from './Tooltip-B4LAymKA.mjs';
import { _ as _sfc_main$n } from './Container-DctvYi3A.mjs';
import { _ as _export_sfc, h as __nuxt_component_3$1, a as useAppConfig, e as useRoute, b as useI18n, f as appConfig$1, g as useState } from './server.mjs';
import { _ as _sfc_main$l } from './Modal-Rap96-X_.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="" class="${ssrRenderClass([`text-${props.size}`, ""])}"${_scopeId}> Frontend </span><span class="${ssrRenderClass([`text-${props.size}`, "font-bold text-primary!"])}"${_scopeId}>Engineer</span>`);
          } else {
            return [
              createVNode("span", {
              ...
              createVNode("span", {
                class: ["font-bold text-primary!", `text-${props.size}`]
              }, "Engineer", 2)
            ];
          }
        }),
...
const __nuxt_component_2$1 = Object.assign(_sfc_main$h, { __name: "ActionsLogo" });
const theme$8 = {
  "slots": {
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => {
              if (unref(isLeading) && unref(leadingIconName)) {
                _push2(ssrRenderComponent(_sfc_main$3$2, {
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                unref(isLeading) && unref(leadingIconName) ? (openBlock(), createBlock(_sfc_main$3$2, {
                  key: 0,
                  name: unref(leadingIconName),
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: props.ui?.leadingIcon })
              ...
              renderSlot(_ctx.$slots, "trailing", { ui: ui.value }, () => [
                unref(isTrailing) && unref(trailingIconName) ? (openBlock(), createBlock(_sfc_main$3$2, {
                  key: 0,
                  name: unref(trailingIconName),
                  "data-slot": "trailingIcon",
                  class: ui.value.trailingIcon({ class: props.ui?.trailingIcon })
                    ...
                    if (_push3) {
                      ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                        ...
                        if (__props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length) {
                          _push3(ssrRenderComponent(_sfc_main$3$2, {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          item.badge || item.badge === 0 ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                            key: 0,
                            color: "neutral",
                            variant: "outline",
                            size: item.ui?.linkTrailingBadgeSize || props.ui?.linkTrailingBadgeSize || ui.value.linkTrailingBadgeSize()
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$3$2, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig2).ui.icons.chevronDown,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
                          }, null, 8, ["name", "class"])) : item.trailingIcon ? (openBlock(), createBlock(_sfc_main$3$2, {
                            key: 2,
                            name: item.trailingIcon,
                            "data-slot": "linkTrailingIcon",
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                renderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                  ...
                  item.avatar ? (openBlock(), createBlock(_sfc_main$3$1, mergeProps({
                    ...
                    "data-slot": "linkLeadingAvatar",
                    class: ui.value.linkLeadingAvatar({ class: [props.ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active, disabled: !!item.disabled })
                  }), null, 16, ["size", "class"])) : item.icon ? (openBlock(), createBlock(_sfc_main$3$2, {
                    key: 1,
                    name: item.icon,
                    "data-slot": "linkLeadingIcon",
                    class: ui.value.linkLeadingIcon({ class: [props.ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active, disabled: !!item.disabled })
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createBlock("span", {
                  ...
                  item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$3$2, {
                    key: 0,
                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                    "data-slot": "linkLabelExternalIcon",
                    class: ui.value.linkLabelExternalIcon({ class: [props.ui?.linkLabelExternalIcon, item.ui?.linkLabelExternalIcon], active })
                              ...
                              if (_push5) {
                                                      ...
                                                      if (_push8) {
                                                        _push8(ssrRenderComponent(_sfc_main$2$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                          ...
                                                          default: withCtx((_4, _push9, _parent9, _scopeId8) => {
                                                            if (_push9) {
                                                              if (childItem.icon) {
                                                                _push9(ssrRenderComponent(_sfc_main$3$2, {
                                                                  name: childItem.icon,
                                                              ...
                                                              return [
                                                                childItem.icon ? (openBlock(), createBlock(_sfc_main$3$2, {
                                                                  key: 0,
                                                                  name: childItem.icon,
                                                                  "data-slot": "childLinkIcon",
                                                                  class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$3$2, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig2).ui.icons.external,
                                                                    "data-slot": "childLinkLabelExternalIcon",
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                ...
                                return [
                                  __props.orientation === "vertical" && __props.collapsed && item.children?.length && (!!props.popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$f, mergeProps({ key: 0 }, { ...popoverProps.value, ...typeof item.popover === "boolean" ? {} : item.popover || {} }, {
                                    ...
                                    _: 2
                                  }, 1040, ["ui"])) : __props.orientation === "vertical" && __props.collapsed && (!!props.tooltip || !!item.tooltip) ? (openBlock(), createBlock(_sfc_main$o, mergeProps({
                                    key: 1,
                                    text: unref(get)(item, props.labelKey)
                                  }, { ...tooltipProps.value, ...typeof item.tooltip === "boolean" ? {} : item.tooltip || {} }), {
                                    default: withCtx(() => [
                                                ...
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$2$1, mergeProps({ ref_for: true }, childSlotProps, {
                                                    ...
                                                    default: withCtx((_4, _push8, _parent8, _scopeId7) => {
                                                      if (_push8) {
                                                        if (childItem.icon) {
                                                          _push8(ssrRenderComponent(_sfc_main$3$2, {
                                                            name: childItem.icon,
                                                            "data-slot": "childLinkIcon",
                                                            class: ui.value.childLinkIcon({ class: [props.ui?.childLinkIcon, item.ui?.childLinkIcon], active: childActive })
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UButton, {
        ...
        href: unref(appConfig$1).global.telegram,
        target: "_blank",
        "aria-label": "Telegram"
      }, null, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        href: `mailto:${unref(appConfig$1).global.email}?subject=Hello, from your site}`,
        target: "_blank",
        "aria-label": "X"
      }, null, _parent));
      _push(ssrRenderComponent(_component_UButton, {
        ...
        href: unref(appConfig$1).global.github,
        target: "_blank",
        "aria-label": "GitHub"
      }, null, _parent));
      if (unref(locale) === "ru") {
        _push(ssrRenderComponent(_component_UButton, {
          ...
          href: unref(appConfig$1).global.resume.ru,
          target: "_blank",
        ...
        _push(ssrRenderComponent(_component_UButton, {
          variant: "ghost",
          icon: "i-lucide-download",
          href: unref(appConfig$1).global.resume.en,
          target: "_blank",
          "aria-label": "Download PDF"
        }, null, _parent));
      }
...
const __nuxt_component_3 = Object.assign(_sfc_main$d, { __name: "ActionsContacts" });
const theme$5 = {
  "base": "relative",
  "variants": {
    "size": {
...
const _sfc_main$c = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.fieldGroup || {} }));
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UFieldGroup = _sfc_main$c;
      const _component_UButton = _sfc_main$m;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, {
              label: "RUS",
              disabled: unref(locale) === "ru",
              onClick: ($event) => unref(setLocale)("ru")
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_UButton, {
              label: "ENG",
              disabled: unref(locale) === "en",
...
const __nuxt_component_4$1 = Object.assign(_sfc_main$b, { __name: "SelectLocale" });
...
const __nuxt_component_0 = Object.assign(_sfc_main$a, { __name: "ActionsTop" });
const theme$4 = {
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$4), ...appConfig2.ui?.main || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$3$1, mergeProps({
                  ...
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, 16, ["size", "class"])) : __props.icon ? (openBlock(), createBlock(_sfc_main$3$2, {
                  key: 1,
                  name: __props.icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: props.ui?.icon })
...
const __nuxt_component_2 = Object.assign(_sfc_main$4, { __name: "UApp" });
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AnimatedButton, mergeProps({
        id: "scrollToTopBtn",
        class: "scroll-to-top",
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/actions/up.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_4 = Object.assign(_sfc_main$3, { __name: "ActionsUp" });
const theme = {
  "slots": {
    "root": "",
    "top": "py-8 lg:py-12",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UNavigationMenu = _sfc_main$e;
      const _component_ActionsLogo = __nuxt_component_2$1;
      _push(ssrRenderComponent(_component_UFooter, mergeProps({ class: "border-t border-t-primary/10" }, _attrs), {
        left: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="text-ui-muted text-sm"${_scopeId}>${ssrInterpolate(unref(appConfig$1).footer.credits)}</p>`);
          } else {
            return [
              createVNode("p", { class: "text-ui-muted text-sm" }, toDisplayString(unref(appConfig$1).footer.credits), 1)
            ];
          }
        }),
        right: withCtx((_, _push2, _parent2, _scopeId) => {
...
const __nuxt_component_5 = Object.assign(_sfc_main$1, { __name: "SectionFooter" });
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_ActionsUp = __nuxt_component_4;
  ...
  _push(ssrRenderComponent(_component_UMain, { id: "welcome" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_ActionsUp, null, null, _parent2, _scopeId));
      } else {
        return [
          ...
          createVNode(_component_ActionsUp)
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=default-BoV68ANp.mjs.map
