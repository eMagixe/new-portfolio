  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        id: "welcome",
        class: "h-screen bg-welcome"
      }, _attrs))}><div class="flex flex-col justify-center items-center pt-10 photo">`);
...
const __nuxt_component_4_lazy_visible = createLazyVisibleComponent("components/section/projects.vue", () => import('./projects-jhLScZ_m.mjs').then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=index-C7w-LVjo.mjs.map
