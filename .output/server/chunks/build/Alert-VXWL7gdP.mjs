...
import { u as useLocale, b as _sfc_main$3, _ as _sfc_main$1 } from './Button-DDZVeAG-.mjs';
import { t as tv, b as _sfc_main$3$1 } from './Tooltip-B4LAymKA.mjs';
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$3, mergeProps({
                  ...
                  "data-slot": "avatar",
                  class: ui.value.avatar({ class: props.ui?.avatar })
                }), null, 16, ["size", "class"])) : __props.icon ? (openBlock(), createBlock(_sfc_main$3$1, {
                  key: 1,
                  name: __props.icon,
                  "data-slot": "icon",
                  class: ui.value.icon({ class: props.ui?.icon })
...
//# sourceMappingURL=Alert-VXWL7gdP.mjs.map
