...
import { t as tv, a as _sfc_main$1 } from './Button-C5RHR-UA.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const ui = computed(() => {
      var _a;
      return tv({ extend: tv(theme), ...((_a = appConfig.ui) == null ? void 0 : _a.pageHeader) || {} })({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (__props.headline || !!slots.headline) {
              _push2(`<div data-slot="headline" class="${ssrRenderClass(ui.value.headline({ class: (_a2 = props.ui) == null ? void 0 : _a2.headline }))}"${_scopeId}>`);
            ...
            _push2(`<div data-slot="container" class="${ssrRenderClass(ui.value.container({ class: (_b = props.ui) == null ? void 0 : _b.container }))}"${_scopeId}><div data-slot="wrapper" class="${ssrRenderClass(ui.value.wrapper({ class: (_c = props.ui) == null ? void 0 : _c.wrapper }))}"${_scopeId}>`);
            if (__props.title || !!slots.title) {
              _push2(`<h1 data-slot="title" class="${ssrRenderClass(ui.value.title({ class: (_d = props.ui) == null ? void 0 : _d.title }))}"${_scopeId}>`);
            ...
            if (((_e = __props.links) == null ? void 0 : _e.length) || !!slots.links) {
              _push2(`<div data-slot="links" class="${ssrRenderClass(ui.value.links({ class: (_f = props.ui) == null ? void 0 : _f.links }))}"${_scopeId}>`);
            ...
            if (__props.description || !!slots.description) {
              _push2(`<div data-slot="description" class="${ssrRenderClass(ui.value.description({ class: (_g = props.ui) == null ? void 0 : _g.description }))}"${_scopeId}>`);
...
//# sourceMappingURL=PageHeader-DHvPt5JG.mjs.map
