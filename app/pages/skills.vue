...
useSeoMeta({
	...
	description:
		'Список навыков и инструментов, которыми владеет Евченко Максим, Frontend-разработчик с многолетним опытом создания современных веб-приложений.',
	ogDescription:
		'Список навыков и инструментов, которыми владеет Евченко Максим, Frontend-разработчик с многолетним опытом создания современных веб-приложений.',
...
<template>
	<UContainer>
		<UPageHeader title="Навыки" />
		<div class="w-full flex flex-col md:flex-row justify-start items-start gap-5">
			<section>
				<h3 class="mt-5 mb-5 border-b pb-5 border-b-gray-200">Основные инструменты</h3>
				<UPageList divide>
					<UPageCard
			...
			<section>
				<h3 class="mt-5 mb-5 border-b pb-5 border-b-gray-200">Дополнительные инструменты</h3>
				<UPageList divide>
					<UPageCard
